...
\begin{center}
    {\captionfontsize \textsf{\textbf{UNION}}}\end{center}
        {\textfontsize Reveal cards until two cards with a \KI\ are found. Use the union of the card rules applied in either order.}
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
...
\begin{center}
    {\captionfontsize \textsf{\textbf{JEDI ORDER}}}\end{center}
        {\textfontsize If you only have one \KI\ on the board, it can also move and take like a Queen.}
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
...
\begin{center}
    {\captionfontsize \textsf{\textbf{LONG LEAPER}}}\end{center}
        {\textfontsize \Sym\KI$\Move$: \Queen\Move\newline\Sym\KII$\Attack$: \Jump\Queen\Move}
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
...
\begin{center}
    {\captionfontsize \textsf{\textbf{SITH v2}}}\end{center}
        {\textfontsize If one {\Sym\KI}\ is captured, the other is as well. Drop both on the same turn.}
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
        {\quotefontsize \textit{Always two, there are. No more, no less. A master and an apprentice. ---Yoda}}\\[-2\baselineskip]
    };
    \node[circle,draw,text=black](c) at (.5,\cardheight-.5){C};
