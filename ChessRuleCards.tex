...
\begin{center}
    {\captionfontsize \textsf{\textbf{PENALTY BOX}}}\end{center}
        {\textfontsize If an enemy piece captures last turn, you may move it to any empty square.}
...
\begin{tikzpicture}
    ...
    \begin{center} {\fontsize{80pt}{60pt}\selectfont ♘}\\\end{center}
\begin{center}
    {\captionfontsize \textsf{\textbf{MAJOR X KNIGHT}}}\end{center}
        {\textfontsize \Sym\Knight$\Move^+\Attack^+$: \PM[2,2]}
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
...
\begin{tikzpicture}
    ...
    \begin{center} {\fontsize{80pt}{60pt}\selectfont ♘}\\\end{center}
\begin{center}
    {\captionfontsize \textsf{\textbf{MINOR + KNIGHT}}}\end{center}
        {\textfontsize \Sym\Knight$\Move^+\Attack^+$: \PM[0,1]}
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
...
\begin{tikzpicture}
    ...
    \begin{center} {\fontsize{80pt}{60pt}\selectfont ♘}\\\end{center}
\begin{center}
    {\captionfontsize \textsf{\textbf{MAJOR + KNIGHT}}}\end{center}
        {\textfontsize \Sym\Knight$\Move^+\Attack^+$: \PM[0,2]}
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
...
\begin{center}
    {\captionfontsize \textsf{\textbf{MAGNETO}}}\end{center}
        {\textfontsize Bishops can't attack, and in addition to moving, may move any color piece from one square they can move to to another.}
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
...
\begin{center}
    {\captionfontsize \textsf{\textbf{THREE'S A CROWD}}}\end{center}
        {\textfontsize You may not have more that two of any non-pawn piece on the board, including promted pieces.}
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
...
\begin{center}
    {\captionfontsize \textsf{\textbf{BISHOP CHAMPION}}}\end{center}
        {\textfontsize \Sym\Bishop\Move\Attack: \PM[0,1], \PM[2,2], \PM[2,0]}
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
...
\begin{center}
    {\captionfontsize \textsf{\textbf{BISHOP COCHAMPION}}}\end{center}
        {\textfontsize \Sym\Bishop\Move\Attack: \PM[1,1], \PM[2,2], \PM[2,0]}
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
        {\quotefontsize \textit{Between two evils, I always pick the one I've never tried before. ---Mae West}}\\[-2\baselineskip]
    };
    \node[circle,draw,text=black](c) at (.5,\cardheight-.5){C};
    \end{tikzpicture}%
\hspace{1pt}%
...
\begin{center}
    {\captionfontsize \textsf{\textbf{TELEPORTER}}}\end{center}
        {\textfontsize Identify the piece type adjacent to the King towards the center as a teleporter. Teleporters may move to any open square adjacent to a friendly pawn.}
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
