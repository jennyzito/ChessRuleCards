...
\begin{center}
    {\captionfontsize \textsf{\textbf{JEDI KNIGHT}}}\end{center}
        ...
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
        {\quotefontsize \textit{In my experience, when you think you understand the Force, you realize just how little you know. ---Ahsoka Tano}}\\[-2\baselineskip]
    };
...
\begin{center}
    {\captionfontsize \textsf{\textbf{PRECOCIOUS PAWNS}}}\end{center}
        {\textfontsize Pawns start on the third rank. Draw another card.}\\
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
...
\begin{center}
    {\captionfontsize \textsf{\textbf{FAR MIMIC}}}\end{center}
        {\textfontsize Kings act only as any friendly piece which can move to it. No castling. If pawn can move to king and king is on rank 2, can move 2 as pawn and be taken en-passant.}\\
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
...
\begin{center}
    {\captionfontsize \textsf{\textbf{NEAR MIMIC}}}\end{center}
        {\textfontsize Kings act only as any adjacent friendly piece. No castling. If pawn can move to king and king is on rank 2, can move 2 as pawn and be taken en-passant.}\\
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
        {\quotefontsize \textit{Quote needed}}\\[-2\baselineskip]
    };
    \node[circle,draw,text=black](c) at (.5,\cardheight-.5){?};
...
\begin{center}
    {\captionfontsize \textsf{\textbf{CAMOUFLAGE}}}\end{center}
        {\textfontsize You can move through pieces on squares matching your color.}\\
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
        {\quotefontsize \textit{\tiny Camouflage is a game we all like to play, but our secrets are as surely revealed by what we want to seem to be as by what we want to conceal. ---Russell Lynes}}\\[-2\baselineskip]
    };
    \node[circle,draw,text=black](c) at (.5,\cardheight-.5){C};
    \end{tikzpicture}%
\begin{tikzpicture}
...
\begin{center}
    {\captionfontsize \textsf{\textbf{PARACHUTE}}}\end{center}
        {\textfontsize You may pick up friendly pieces. Draw another card.}\\
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
        {\quotefontsize \textit{Quote needed}}\\[-2\baselineskip]
    };
    \node[circle,draw,text=black](c) at (.5,\cardheight-.5){?};
...
\begin{center}
    {\captionfontsize \textsf{\textbf{MOVE TWICE}}}\end{center}
        {\textfontsize Move twice, or any other action once.}\\
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
...
\begin{center}
    {\captionfontsize \textsf{\textbf{TAKE TWICE}}}\end{center}
        {\textfontsize Take twice, or any other action once.}\\
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
...
\begin{center}
    {\captionfontsize \textsf{\textbf{BISHOP-KNIGHT SWAP}}}\end{center}
        {\textfontsize Bishops take like Knights. Knights take backward like Bishops. Both move normally.}\\
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
        {\quotefontsize \textit{Quote needed}}\\[-2\baselineskip]
    };
    \node[circle,draw,text=black](c) at (.5,\cardheight-.5){?};
...
\begin{center}
    {\captionfontsize \textsf{\textbf{CROWNED BISHOP}}}\end{center}
        {\textfontsize Bishops may also move/take live a King.}\\
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
...
\begin{center}
    {\captionfontsize \textsf{\textbf{CROWNED CASTLE}}}\end{center}
        {\textfontsize Rooks may also move/take live a King.}\\
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
...
\begin{center}
    {\captionfontsize \textsf{\textbf{BLOCKADE}}}\end{center}
        {\textfontsize At the end of a Rook move, it may be inverted. Upside-down rooks cannot be taken or attack. Draw another card.}\\
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
...
\begin{center}
    {\captionfontsize \textsf{\textbf{SIEGE TOWER}}}\end{center}
        {\textfontsize A piece may move legally to where there is a rook. It goes on top making a combined piece. The combination acts as the bottom rook. The piece on top can move off as a normal action. Stacks are ok. Multi-color is ok.}\\
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
...
\begin{center}
    {\captionfontsize \textsf{\textbf{IMMOBILIZER}}}\end{center}
        {\textfontsize Pieces adjacent to an enemy Rook may not move. Rooks may not capture. Ultima Chess.}\\
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
...
\begin{center}
    {\captionfontsize \textsf{\textbf{BANISHER}}}\end{center}
        {\textfontsize Bishops only move like Queens and banish an adjacent non-King enemy piece to any empty square.}\\
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
...
\begin{center}
    {\captionfontsize \textsf{\textbf{BISHOP CHAMELEON}}}\end{center}
        {\textfontsize Bishops move normally, but only attack pieces that attack them. Bishops attack each other normally. Ultima Chess.}\\
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
...
\begin{center}
    {\captionfontsize \textsf{\textbf{BISHOP LONG LEAPER}}}\end{center}
        {\textfontsize Bishops move like a queen, but take by leaping over a piece. Ultima Chess.}\\
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
