...
\begin{tikzpicture}
    ...
    { 
    \begin{center} {\fontsize{80pt}{60pt}\selectfont \KIV}\\\end{center}
\begin{center}
    {\captionfontsize \textsf{\textbf{TELEPORTER}}}\end{center}
        {\textfontsize \KIV\ may move to any open square adjacent to a friendly pawn.}
...
\begin{center}
    {\captionfontsize \textsf{\textbf{MAGNETO}}}\end{center}
        {\textfontsize Bishops can't attack, and in addition to moving, may move any friendly piece from one square they can move to to another.}
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
