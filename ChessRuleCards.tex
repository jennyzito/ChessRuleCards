...
\begin{center}
    {\captionfontsize \textsf{\textbf{NONABELIAN}}}\end{center}
        {\textfontsize Reveal cards until two non-commuting cards are found. Use those in the most interesting order.}
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
...
\begin{center}
    {\captionfontsize \textsf{\textbf{COPYCAT}}}\end{center}
        {\textfontsize {\Sym\KII} may move/take like the last piece the opponent moved.}
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
...
\begin{tikzpicture}
    ...
    \node[text width=(\cardwidth-\strippadding-2*\textpadding)*1cm,below right,inner sep=0] at (\strippadding+\textpadding,\cardheight-\textpadding) 
    { 
    \begin{center} {\fontsize{80pt}{60pt}\selectfont \Pawn\King}\\\end{center}
\begin{center}
    {\captionfontsize \textsf{\textbf{IT FOLLOWS}}}\end{center}
        ...
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
        {\quotefontsize \textit{\tiny Love make us poets, and the approach of death should make us philosophers.---George Santayana}}\\[-2\baselineskip]
    };
    \node[circle,draw,text=black](c) at (.5,\cardheight-.5){C};
    \node[circle,draw,text=black](c) at (\cardwidth-.5,\cardheight-.5){\diff};
    \end{tikzpicture}%
