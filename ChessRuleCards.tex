...
\begin{center}
    {\captionfontsize \textsf{\textbf{ASSASSIN}}}\end{center}
        {\textfontsize \KI\ capture by moving past an adjacent piece orthogonal to the movement.}
...
\begin{center}
    {\captionfontsize \textsf{\textbf{BACKGAMMON PAWNS}}}\end{center}
        {\textfontsize You may do two pawn actions in a turn. Pawns may move to a square containing any number of friendly pawns. Pawns sharing a square cannot be captured.}
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
...
\begin{tikzpicture}
    ...
    \node[text width=(\cardwidth-\strippadding-2*\textpadding)*1cm,below right,inner sep=0] at (\strippadding+\textpadding,\cardheight-\textpadding) 
    { 
    \begin{center} {\fontsize{80pt}{60pt}\selectfont \NoPawn\NoKnight}\\\end{center}
\begin{center}
    {\captionfontsize \textsf{\textbf{NO CLONING THEOREM}}}\end{center}
        {\textfontsize You cannot act with a \NoPawn\NoKnight\ piece your opponent just used.}
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
