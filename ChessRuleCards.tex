...
\begin{center}
    {\captionfontsize \textsf{\textbf{SITH}}}\end{center}
        {\textfontsize If one \Bishop\ is captured, the other is as well. When dropped both must be placed on adjacent squares.}
...
\begin{center}
    {\captionfontsize \textsf{\textbf{AGENT SMITH}}}\end{center}
        {\textfontsize Your \Queen\ may switch positions with any friendly \NoKing\ piece.}
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
...
\begin{center}
    {\captionfontsize \textsf{\textbf{FAIR UNFAIR}}}\end{center}
        {\textfontsize Reveal cards until two '+' cards are found. The first applies to white, the second applies to black.}
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
...
\begin{center}
    {\captionfontsize \textsf{\textbf{10x8 BOARD}}}\end{center}
        {\textfontsize Add and additional rank on the top and bottom.}
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
...
\item 1=NBRQ, 2=BNRQ, -1=RNBQ.\item Action=Move, Attack or Drop\item Retreat=Move away from an adjacent piece and capture\end{enumerate}
}
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
