...
\begin{center}
    {\captionfontsize \textsf{\textbf{NO STALLING}}}\end{center}
        {\textfontsize Captured pieces are placed in a staging area. You may only remove a piece from the staging area if your partner has a piece there.}
...
\item 1=NBRQ, 2=BNRQ, -1=RNBQ.\item Action=Move, Attack or Drop\end{enumerate}
}
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
