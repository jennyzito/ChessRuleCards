...
\begin{center}
    {\captionfontsize \textsf{\textbf{NERFED}}}\end{center}
        {\textfontsize Choose a nerf from the deck. Place a token under each \KI. Any piece that takes a nerfed piece gains the token.}
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
        {\quotefontsize \textit{Why you no good, scruffy looking, nerf herder! ---George Lucas}}\\[-2\baselineskip]
    };
...
\begin{tikzpicture}
    ...
    \begin{center} {\fontsize{80pt}{60pt}\selectfont \KI}\\\end{center}
\begin{center}
    {\captionfontsize \textsf{\textbf{SPIDERMAN}}}\end{center}
        {\textfontsize \KI\Move+: May also move to board edge in an \Queen\ direction.}
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
        {\quotefontsize \textit{Go web! Fly! Up, up, and away web! Shazaam! Go! Go! Go web go! Tally ho. ---Spider-Man}}\\[-2\baselineskip]
    };
    \node[circle,draw,text=black](c) at (.5,\cardheight-.5){C};
...
\begin{tikzpicture}
    ...
    \begin{center} {\fontsize{80pt}{60pt}\selectfont \KI}\\\end{center}
\begin{center}
    {\captionfontsize \textsf{\textbf{ELDER WAND}}}\end{center}
        {\textfontsize \small Place a token under \KI\ that grants that piece the corresponding buff. Any capturing piece gains the tokened buff.}
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
        {\quotefontsize \textit{If it's true, what you say, that he has the Elder Wand, I'm afraid you really don't stand a chance. ---Olivander}}\\[-2\baselineskip]
    };
    \node[circle,draw,text=black](c) at (.5,\cardheight-.5){C};
    \node[circle,draw,text=black](c) at (\cardwidth-.5,\cardheight-.5){+};
    \end{tikzpicture}%
...
\begin{tikzpicture}
    ...
    \begin{center} {\fontsize{80pt}{60pt}\selectfont \KI}\\\end{center}
\begin{center}
    {\captionfontsize \textsf{\textbf{SIEGE}}}\end{center}
        {\textfontsize \small You may place or remove a token under any piece. This piece cannot move and attacks by removing pieces at squares it attacks. One siege token per army.}
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
        {\quotefontsize \textit{The skillful leader subdues the enemy's troops without any fighting. ---Sun Tzu}}\\[-2\baselineskip]
    };
    \node[circle,draw,text=black](c) at (.5,\cardheight-.5){C};
    \node[circle,draw,text=black](c) at (\cardwidth-.5,\cardheight-.5){+};
    \end{tikzpicture}%
...
\begin{tikzpicture}
    ...
    \node[text width=(\cardwidth-\strippadding-2*\textpadding)*1cm,below right,inner sep=0] at (\strippadding+\textpadding,\cardheight-\textpadding) 
    { 
    \begin{center} {\fontsize{80pt}{60pt}\selectfont \Pawn\hspace{-0.3em}\Pawn\hspace{-0.3em}\Pawn}\\\end{center}
\begin{center}
    {\captionfontsize \textsf{\textbf{DEVIL'S BARGAIN}}}\end{center}
        {\textfontsize You may sacrifice three pawns on your board to remove any \NoKing\ piece.}
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
        {\quotefontsize \textit{The devil can cite Scripture for his purpose.  ---William Shakespeare}}\\[-2\baselineskip]
    };
    \node[circle,draw,text=black](c) at (.5,\cardheight-.5){C};
...
\begin{center}
    {\captionfontsize \textsf{\textbf{TWO FACED}}}\end{center}
        {\textfontsize Rooks may invert after it acts. Inverted rooks act like a \KI.}
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
