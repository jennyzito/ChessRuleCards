...
\begin{center}
    {\captionfontsize \textsf{\textbf{BACKGAMMON PAWNS}}}\end{center}
        {\textfontsize \Pawn$+$: May do two \Move/\Attack. \Pawn may move to a square with other friendly pawns. \Pawn sharing a square cannot be captured.}
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
...
\begin{tikzpicture}
    ...
    \begin{center} {\fontsize{80pt}{60pt}\selectfont \KI}\\\end{center}
\begin{center}
    {\captionfontsize \textsf{\textbf{COCHAMPION}}}\end{center}
        {\textfontsize }
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
